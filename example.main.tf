...
module "s3-bucket" {
  source      = "git::https://github.com/christianhesels/terraform-s3-cloudfront-website.git//s3-bucket"
  bucket_name = var.domain_name
  source_file = "index.html"
}

module "acm-cert" {
  source      = "git::https://github.com/christianhesels/terraform-s3-cloudfront-website.git//acm-cert"
...
module "route53" {
  source      = "git::https://github.com/christianhesels/terraform-s3-cloudfront-website.git//route53"
  domain_name = var.domain_name
...
module "cloud-front" {
  source              = "git::https://github.com/christianhesels/terraform-s3-cloudfront-website.git//cloud-front"
  acm_certificate_arn = module.acm-cert.acm_certificate_arn
...
module "create-alias" {
  source      = "git::https://github.com/christianhesels/terraform-s3-cloudfront-website.git//create-alias"
  domain_name = var.domain_name
